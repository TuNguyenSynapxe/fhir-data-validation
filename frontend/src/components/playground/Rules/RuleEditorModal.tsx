...
export const RuleEditorModal: React.FC<RuleEditorModalProps> = ({
  ...
  // Route Required, Regex, QuestionAnswer, FixedValue, AllowedValues, ArrayLength, CustomFHIRPath, RequiredResources to RuleForm
    ...
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <div className="relative bg-white rounded-lg shadow-xl w-full max-w-2xl h-full max-h-[90vh] overflow-hidden flex flex-col">
          <RuleForm
            mode="edit"
            ruleType={rule.type as 'Required' | 'Regex' | 'QuestionAnswer' | 'FixedValue' | 'AllowedValues' | 'ArrayLength' | 'CustomFHIRPath' | 'RequiredResources'}
            initialRule={rule}
            onCancel={onClose}
            onSave={onSave}
