...
/// 
/// DLL-SAFETY: Authoring-only (generates UX metadata for Playground)
/// Runtime DLL consumers can skip explanation generation by:
/// - Setting ValidationMode="standard" (explanations not generated)
/// - Ignoring ValidationError.Explanation field (always nullable)
/// 
/// DESIGN PRINCIPLES:
